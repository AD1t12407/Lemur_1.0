...
const CTASection: React.FC = () => {
  ...
  return (
    <section className="py-40 bg-gray-50 dark:bg-gray-950 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <motion.div
          ...
          className="mb-32"
        >
          <div className="bg-white dark:bg-gray-900 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-3xl p-16 text-center shadow-lg max-w-2xl mx-auto">
            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.button
                    type="submit"
                    className="group w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-3 px-6 rounded-xl font-semibold flex items-center justify-center space-x-2 shadow-lg transition-all duration-200"
                    whileHover={{ 
                      scale: 1.02, 
